...
write.table(FT_metacyc,"cyclic_analysis/wol2_rna_pipeline/FT_metacycle/meta2d_filtered_rna_FT_wannot.txt",sep = "\t",row.names = FALSE, quote=FALSE)
...
FA_metacyc<-fread("cyclic_analysis/wol2_rna_pipeline/FA_metacycle/meta2d_filtered_rna_FA.txt")%>%
  ...
  #mutate(label_name=paste(FeatureID, Name, sep=" "))
  dplyr::select(FeatureID,Name, everything())
write.table(FA_metacyc,"cyclic_analysis/wol2_rna_pipeline/FA_metacycle/meta2d_filtered_rna_FA_wannot.txt",sep = "\t",row.names = FALSE, quote=FALSE)
...
NA_metacyc<-fread("cyclic_analysis/wol2_rna_pipeline/NA_metacycle/meta2d_filtered_rna_NA.txt")%>%
  ...
  #mutate(label_name=paste(FeatureID, Name, sep=" "))
  dplyr::select(FeatureID,Name, everything())
write.table(NA_metacyc,"cyclic_analysis/wol2_rna_pipeline/NA_metacycle/meta2d_filtered_rna_NA_wannot.txt",sep = "\t",row.names = FALSE, quote=FALSE)
