...
write.table(annot,"BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/library/merged_results_with_gnps_justBA.tsv",sep = "\t",row.names = FALSE, quote=FALSE)  

mtb<-fread("BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/clustering/featuretable_reformated.csv")%>%
  filter(`row ID` %in% annot$`#Scan#`)
write_csv(mtb, "BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/clustering/featuretable_reformated_justBA.csv")
#####################################################################################################

## Cleanup feature quant table from MZmine ##########################################################
norm <- read.csv("BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/clustering/featuretable_reformated.csv")%>%
  dplyr::select(-"Unnamed..162")
# norm <- read.csv("BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/clustering/featuretable_reformated_justBA.csv")%>%
#   dplyr::select(-"Unnamed..162")
...
#write_csv(norm_iimn, "BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/clustering/featuretable_reformated_justBA_summcollapse.csv")
write_csv(norm_iimn, "BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/clustering/featuretable_reformated_summcollapse.csv")
...
#write_csv(norm_iimn_rclr, "BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/clustering/featuretable_reformated_justBA_summcollapse_cln_rclr.csv")
write_csv(norm_iimn_rclr, "BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/clustering/featuretable_reformated_summcollapse_cln_rclr.csv")
...
#library_ID <- read.delim("BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/library/merged_results_with_gnps_justBA_curatedconjannot.tsv")%>%
library_ID <- read.delim("BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/library/merged_results_with_gnps.tsv")%>%
...
result_list <- library_ID %>%
  ...
  dplyr::select(c(1,12,2:11,13:47))%>%
...
#write.table(result_list,"BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/library/merged_results_with_gnps_justBA_curatedconjannot_collapse.tsv",sep = "\t",row.names = FALSE, quote=FALSE)  
write.table(result_list,"BSH/BSH_ENB/GNPS_fecal_mtb/nf_output/library/merged_results_with_gnps_collapse.tsv",sep = "\t",row.names = FALSE, quote=FALSE)  
