...
norm <- read.csv("BSH/BSH_ENB/GNPS/nf_output/clustering/featuretable_reformated_justBA.csv")%>%
...
write_csv(norm_iimn, "BSH/BSH_ENB/GNPS/nf_output/clustering/featuretable_reformated_justBA_summcollapse.csv")
write_csv(norm_iimn, "BSH/BSH_ENB/GNPS/nf_output/clustering/featuretable_reformated_justBA_summcollapse_cln.csv")
...
write_csv(norm_iimn_rclr, "BSH/BSH_ENB/GNPS/nf_output/clustering/featuretable_reformated_justBA_summcollapse_cln_rclr.csv")
...
write.table(result_list,"BSH/BSH_ENB/GNPS/nf_output/networking/library-results-merged_results_with_gnps_justBA_collapse.tsv",sep = "\t",row.names = FALSE, quote=FALSE)  
