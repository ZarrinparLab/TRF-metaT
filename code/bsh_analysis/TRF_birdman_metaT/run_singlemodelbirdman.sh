...
TABLEID="species_pfam_BSHonly_clean_rmzero_noNT"
TABLE="/projects/zl_trf_metat/trf_metaT_woltka_results/wol2_wrep_notnorm/BSH_results/"$TABLEID".biom"
SLURMS="/projects/zl_trf_metat/trf_metaT_woltka_results/wol2_wrep_notnorm/BSH_results/slurm_out/"$TABLEID
OUTDIR="/projects/zl_trf_metat/trf_metaT_woltka_results/wol2_wrep_notnorm/BSH_results/inferences/"$TABLEID
LOGDIR="/projects/zl_trf_metat/trf_metaT_woltka_results/wol2_wrep_notnorm/BSH_results/logs/"$TABLEID
mkdir -p $SLURMS
mkdir -p $OUTDIR
mkdir -p $LOGDIR
