...
#SBATCH --output=/mnt/zarrinpar/Pynchon/Notebooks/sfloresr/TRF-metaT/data/bsh_analysis/BSH_proteindb_metaT/birdman_outputs/slurm_out/%x.out
...
for inference_dir in glob.glob('/mnt/zarrinpar/Pynchon/Notebooks/sfloresr/TRF-metaT/data/bsh_analysis/BSH_proteindb_metaT/birdman_outputs/inferences/*'):
