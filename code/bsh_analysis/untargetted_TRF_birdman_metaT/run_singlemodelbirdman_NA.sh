...
TABLEID="species_pfam_BSHonly_clean_rmzero_noNT_lightNA"
TABLE="/mnt/zarrinpar/Pynchon/Notebooks/sfloresr/TRF-metaT/data/bsh_analysis/species_pfam_metaT/"$TABLEID".biom"
SLURMS="/mnt/zarrinpar/Pynchon/Notebooks/sfloresr/TRF-metaT/data/bsh_analysis/species_pfam_metaT/birdman_outputs/slurm_out_NA/"$TABLEID
OUTDIR="/mnt/zarrinpar/Pynchon/Notebooks/sfloresr/TRF-metaT/data/bsh_analysis/species_pfam_metaT/birdman_outputs/inferences_NA/"$TABLEID
LOGDIR="/mnt/zarrinpar/Pynchon/Notebooks/sfloresr/TRF-metaT/data/bsh_analysis/species_pfam_metaT/birdman_outputs/logs_NA/"$TABLEID
mkdir -p $SLURMS
mkdir -p $OUTDIR
mkdir -p $LOGDIR
