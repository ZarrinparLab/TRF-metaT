...
#SBATCH --chdir=/projects/zl_trf_metat/trf_metaT_woltka_results/wol2_wrep_notnorm/BSH_results/targeted_BSH/inferences/
#SBATCH --output=/projects/zl_trf_metat/trf_metaT_woltka_results/wol2_wrep_notnorm/BSH_results/targeted_BSH/slurm_out/%x.out
...
for inference_dir in glob.glob('/projects/zl_trf_metat/trf_metaT_woltka_results/wol2_wrep_notnorm/BSH_results/targeted_BSH/inferences/genome*'):
