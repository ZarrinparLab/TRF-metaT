...
#SBATCH --chdir=/mnt/zarrinpar/Pynchon/Notebooks/sfloresr/TRF-metaT/data/bsh_analysis/species_pfam_metaG/birdman_outputs/
#SBATCH --output=/mnt/zarrinpar/Pynchon/Notebooks/sfloresr/TRF-metaT/data/bsh_analysis/species_pfam_metaG/birdman_outputs/slurm_out/%x.out
...
for inference_dir in glob.glob('/mnt/zarrinpar/Pynchon/Notebooks/sfloresr/TRF-metaT/data/bsh_analysis/species_pfam_metaG/birdman_outputs/inferences/*'):
